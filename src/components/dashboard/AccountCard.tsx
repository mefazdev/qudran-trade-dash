...
export function AccountCard({ account }: AccountCardProps) {
    ...
    return (
        <div className="relative h-fit group overflow-hidden rounded-xl border border-white/5 bg-card/50 backdrop-blur-md transition-all duration-300 hover:border-white/10 hover:shadow-lg hover:shadow-primary/5">
            {/* Decorative Glow */}
            <div className={cn(
                ...
                <div className="bg-white/[0.02] border-t border-white/5">
                    <div className="px-5 py-2 flex items-center justify-between">
                        ...
                        <button
                            ...
                            className="p-1 rounded-md hover:bg-white/5 text-muted-foreground hover:text-foreground transition-all cursor-pointer relative z-10"
                    ...
                    {showPositions && (
                        <div className="max-h-40 overflow-y-auto custom-scrollbar animate-in fade-in slide-in-from-top-2 duration-200">
